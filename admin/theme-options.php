...
//Stylesheets Reader
$alt_stylesheet_path = OF_FILEPATH . '/css/';
...
$options[] = array( "name" => "Main Layout",
					...
					"type" => "images",
					"options" => array(
						'layout-2r' => $url . '2cr.png',
						'layout-2l' => $url . '2cl.png')
					);
...
$options[] = array( "name" => "CSS Classes",
					"type" => "heading");

$options[] = array( "name" => "Site Title",
					"desc" => "Site Title CSS Class. (defaut: sixcol)",
					"id" => $shortname."_site_title_class",
					"std" => "sixcol",
					"type" => "text");
					
$options[] = array( "name" => "Site Description",
					"desc" => "Site Description CSS Class. (defaut: sixcol)",
					"id" => $shortname."_site_description_class",
					"std" => "sixcol last",
					"type" => "text");
					
$options[] = array( "name" => "Main Content Class",
					"desc" => "Main Content CSS Class. (defaut: ninecol)",
					"id" => $shortname."_main_content_class",
					"std" => "ninecol",
					"type" => "text"); 

$options[] = array( "name" => "Primary Sidebar Class",
					"desc" => "Primary Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_primary_sidebar_class",
					"std" => "threecol last",
					"type" => "text"); 
					
$options[] = array( "name" => "Secondary Sidebar Class",
					"desc" => "Secondary Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_secondary_sidebar_class",
					"std" => "threecol last",
					"type" => "text"); 
					
$options[] = array( "name" => "First (above content/footer) Sidebar Class",
					"desc" => "First (above content/footer) Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_firstAF_sidebar_class",
					"std" => "threecol",
					"type" => "text");
					
$options[] = array( "name" => "Second (above content/footer) Sidebar Class",
					"desc" => "Second (above content/footer) Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_secondAF_sidebar_class",
					"std" => "threecol",
					"type" => "text");
					
$options[] = array( "name" => "Third (above content/footer) Sidebar Class",
					"desc" => "Third (above content/footer) Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_thirdAF_sidebar_class",
					"std" => "threecol",
					"type" => "text");

$options[] = array( "name" => "Fourth (above content/footer) Sidebar Class",
					"desc" => "Fourth (above content/footer) Sidebar CSS Class. (defaut: threecol)",
					"id" => $shortname."_fourthAF_sidebar_class",
					"std" => "threecol last",
					"type" => "text");
