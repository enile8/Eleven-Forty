	...
	function optionsframework_wp_head() { 
		...
		//Styles
	     ...
	     if ($style != '') {
	          ...
	          echo '<link href="'. OF_DIRECTORY .'/css/'. $GLOBALS['stylesheet'] . '.css" rel="stylesheet" type="text/css" />'."\n"; 
	     } else { 
	          $GLOBALS['stylesheet'] = get_option('of_alt_stylesheet');
	          if($GLOBALS['stylesheet'] != '')
	               echo '<link href="'. OF_DIRECTORY .'/css/'. $GLOBALS['stylesheet'] .'" rel="stylesheet" type="text/css" />'."\n";         
	          else
	               echo '<link href="'. OF_DIRECTORY .'/css/default.css" rel="stylesheet" type="text/css" />'."\n";         		  
	     }       
