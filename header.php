		...
		<div id="header"><div class="row">
			<div id="masthead">
				<div id="branding" role="banner">
					...
					<<?php echo $heading_tag; ?> id="site-title" class="sixcol">
						<span>
							<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
						</span>
					</<?php echo $heading_tag; ?>>
					<div id="site-description" class="sixcol last"><?php bloginfo( 'description' ); ?></div>
					<?php /* header search form commented out
					<div id="header-search" class="fivecol last">
					<form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>" >
						<div>
								<input type="text" value="" name="s" id="s" class="term" size="31" maxlength="255" />
